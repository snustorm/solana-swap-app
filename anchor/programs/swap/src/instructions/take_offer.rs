...
pub fn process_send_wanted_token_to_maker(ctx: & Context<TakeOffer>) -> Result<()> {
...
pub fn process_withdraw_and_close_vault(ctx: Context<TakeOffer>) -> Result<()> {
    ...
    let accounts_to_close = CloseAccount {
